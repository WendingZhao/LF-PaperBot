...
每周光场图像底层视觉论文追踪与分析系统。项目基于 [RS-PaperClaw](https://github.com/thinson/RS-PaperClaw) 的流水线思路重构，聚焦光场超分、去噪、去模糊、低光增强、去遮挡及恢复重建。

## 能力

- 从 arXiv 的 `cs.CV`、`eess.IV`、`physics.optics` 获取上一自然周论文
